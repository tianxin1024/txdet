...
class tx_YOLOX(SingleStageDetector):
    ...
    def __init__(self,
                 ...
                 init_cfg=None):
        super(tx_YOLOX, self).__init__(backbone, neck, bbox_head, train_cfg,
    ...
    def forward_train(self,
        ...
        losses = super(tx_YOLOX, self).forward_train(img, img_metas, gt_bboxes,
